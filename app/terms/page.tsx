...
const sections = [
  {
    title: '服务说明',
    content: `根·陪伴是一款为清迈陪读家庭设计的智能生活管家服务。我们通过智能技术帮助您整理待办事项、生成行动建议、提醒重要事项。
...
您不得将服务用于任何违法、欺诈或侵害他人权益的活动。`,
  ...
  {
    title: '根·建议免责',
    content: `根·陪伴提供的所有根·建议（包括签证办理、医疗建议、法律事项等）仅供参考，不构成专业意见。

重要决策请咨询相关专业人士。我们不对依据根·建议做出的决定所产生的后果承担责任。`,
  },
  {
    title: '实时信息准确性',
