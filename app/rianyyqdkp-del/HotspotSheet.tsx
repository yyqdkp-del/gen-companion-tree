...
import { THEME, URGENCY_CFG } from './_constants/theme'
import { CAT_EMOJI } from './_constants/categories'
import { useHotspotSheet, isConsumed } from './_hooks/useHotspotSheet'
        ...
        {expanded && (
          <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }}
            ...
            <div style={{ padding: '0 14px 14px', borderTop: `0.5px solid ${cfg.border}30` }}>
              ...
              {convertError && (
                <p style={{ fontSize: 11, color: '#CC3333', marginBottom: 8 }}>
                  添加失败，请重试
                </p>
              )}
