...
import { THEME, GREEN } from './_constants/theme'
import { EVENT_TYPE_EMOJI } from './_constants/categories'
import { useChildSchedule } from './_hooks/useChildSchedule'
import { useChildDailyLog } from './_hooks/useChildDailyLog'
import type { Child, TimelineItem, HealthStatus, MoodStatus } from './_types'
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
      ...
      <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}
        ...
        <motion.button whileTap={{ scale: 0.97 }} onClick={() => onSave(health as HealthStatus, mood as MoodStatus)}
