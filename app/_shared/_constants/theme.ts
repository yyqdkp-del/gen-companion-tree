export const THEME = {
  ...
  text: '#2d322f', // --text-primary（原 #2C3E50 统一为此）
  gold: '#8a7355', // 保留，课表/旅行用
  navy: '#2d3f4a', // 保留，主按钮深色
  muted: '#5a5a4a', // --text-secondary（原 #6B8BAA 统一为此）
} as const

export const GREEN = {
  bg: '#E1F5EE', // 成功态浅底（PWA/完成条等，与 --accent-jade 语义不同）
  border: '#9FE1CB',
  mid: '#5DCAA5',
  deep: '#1D9E75', // layout themeColor、InstallPWA
  dark: '#0F6E56',
} as const
