        ...
        {selectedReminder && (
          ...
          >
            <motion.div initial={{ y: 80, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: 80, opacity: 0 }}
              ...
              style={{ width: '100%', maxWidth: '420px', background: 'rgba(255,255,255,0.92)', backdropFilter: 'blur(40px)', borderRadius: '28px', overflow: 'hidden', boxShadow: '0 20px 60px rgba(0,0,0,0.15)', maxHeight: '80vh', overflowY: 'auto' }}
            >
              {/* 顶部色条 */}
                    ...
                    <div style={{ marginTop: '12px' }}>
                      ...
                      {warnLine && (
                        <div style={{ background: 'rgba(255,107,107,0.06)', borderRadius: '10px', padding: '8px 12px', marginBottom: '8px', border: '1px solid rgba(255,107,107,0.15)' }}>
                          <div style={{ fontSize: '11px', color: '#FF6B6B', lineHeight: 1.6 }}>⚠️ {warnLine.replace('注意：', '')}</div>
                        </div>
                      )}
                      {relatedLine && (
                        <div style={{ background: 'rgba(176,141,87,0.06)', borderRadius: '10px', padding: '8px 12px', marginBottom: '8px' }}>
                          <div style={{ fontSize: '11px', color: THEME.gold, lineHeight: 1.6 }}>🔀 {relatedLine.replace('顺路：', '')}</div>
                        </div>
                      )}
                    </div>
                  )
